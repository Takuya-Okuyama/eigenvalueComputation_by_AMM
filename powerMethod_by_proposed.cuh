#ifndef __POWERMETHOD_BY_PROPOSED__
#define __POWERMETHOD_BY_PROPOSED__

#include "common.h"
#include "core_proposedAMM.cuh"

void square_of_A_by_proposed(device_memory &dm, const bool sanity_check = false)
{
  if (dm.is_init)
  {
    /*------------------------------------------------------------
    ...
    const bool is_output = true)
{
  ...
  cublasSetStream(dm.handle, dm.stream_2);
  ...
  for (std::size_t i = 0; i < step; ++i)
  {
    ...
    {
      square_of_A_by_proposed(dm, p.sanity_check);
    }
